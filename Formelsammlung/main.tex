...
Punktladung: $\boxed{\vec{E}(\vec{r})=\dfrac{1}{4\pi\varepsilon_0}\dfrac{q}{r^2}\hat{r}}$

Diskret: $\boxed{\vec{E}(\vec{r}_0)=\dfrac{1}{4\pi\varepsilon_0}\sum_{i=1}^n\dfrac{q_i}{r_{0i}^2}\hat{r}_{0i}}$ \quad $\vec{F}=q\vec{E}$

Kontinuierlich: $\boxed{\vec{E}(\vec{r})=\dfrac{1}{4\pi\varepsilon_0}\int_{\mathbb{R}^3}\dfrac{\rho(\vec{r}')}{|\vec{r}-\vec{r}'|^3}(\vec{r}-\vec{r}')\,d^3r'}$

pot. Energie: $\ec{E_{\text{pot}}}=|q||E||d|=|q||V|$ \quad $E=V/d$

Kraft: $F=-\nabla \ec{E_{\text{pot}}}$

\textbf{Kugel homogener Ladungsdichte:}
$E(r)=\begin{cases}\dfrac{\rho R^3}{3r^2\varepsilon_0} & r>R\\ \dfrac{\rho r}{3\varepsilon_0} & r<R\end{cases}$ (Elektrisches Feld)

\subsection{Gesetz von Gauss}

$\boxed{\Phi=\oint_{\partial V}\vec{E}\cdot d\vec{a}=\dfrac{1}{\varepsilon_0}\int_V\rho\,dV=\dfrac{q_{\text{eingeschlossen}}}{\varepsilon_0}}$

wähle Fläche senkrecht zu $\vec{E}$; \; $\vec{E}\perp d\vec{a}$: $\vec{E}\cdot d\vec{a}=0$

\subsection{Energie des elektrischen Feldes}

Energiedichte: $\boxed{\ec{u}=\dfrac{\varepsilon_0}{2}E^2}$ \quad Gesamtenergie: $\boxed{\ec{U}=\int_V\dfrac{\varepsilon_0}{2}E^2\,dV}$

\subsection{Das elektrische Potential}

Spannung: $\boxed{V=\varphi=-\int_{r_0}^{r_1}\vec{E}(\vec{r})\,dr}$

Potentialdifferenz: $\varphi_{BA}=\varphi(A)-\varphi(B)=-\int_A^B\vec{E}\,ds$

$\varphi(r)=-\int_\infty^r E(r')\,dr'+\varphi(\infty)$ \quad $\boxed{\vec{E}=-\nabla\varphi}$
...
$\vec{E}=0$ im Inneren $\Rightarrow\boxed{\dfrac{Q(v)}{\varepsilon_0}=0}$

$\varphi=\text{konst.}$ im Inneren; Oberfläche ist Äquipotentialfläche.

$\boxed{\vec{E}=\dfrac{\sigma}{\varepsilon_0}\hat{n}}$ \quad $\sigma=Q/A$
...
Drehmoment: $\boxed{\vec{M}=\vec{p}\times\vec{E}}$
...
Energiedichte: $\boxed{\ec{w_E}=\dfrac{1}{2\varepsilon_0}E^2}$
...
Allgemein: $\boxed{\vec{J}=\sigma\vec{E}}$ \quad $\sigma$: Leitfähigkeit
...
Lorentz-Kraft: $\boxed{\vec{F}=q\vec{E}+q(\vec{v}\times\vec{B})}$

Stromdurchflossener Leiter: $\boxed{\vec{F}_L=\icc{I}(\vec{\ell}\times\vec{B})}$

Ampersches Gesetz: $\boxed{\mu_0 \icc{I}=\oint_{\partial A}\vec{B}\,ds}$
...
$F_y=\dfrac{qI}{2\pi\varepsilon_0 c^2}\dfrac{v}{d}$ \quad Magnetisches Feld: $\boxed{B=\dfrac{\icc{I}}{2\pi\varepsilon_0 c^2 d}}$
...
Magn. Feld unendl. langer Draht: $\boxed{B=\mu_0\dfrac{\icc{I}}{2\pi r}}$ \quad $\boxed{\vec{B}=\dfrac{\vec{k}}{\omega}\times\vec{E}}$

Magnetfeld Zylinderspule: $\boxed{B=\mu_0\dfrac{N}{L}\icc{I}}$ \quad $N$: Gesamtwindungen, $L$: Länge

\subsection{Ampere'sches Gesetz}

$\boxed{\oint_{\partial A}\vec{B}\,ds=\mu_0 \icc{I_{\text{eing}}}=\mu_0\int_A\vec{J}\,d\vec{a}}$ \quad wähle Weg parallel zu $\vec{B}$

$\boxed{\nabla\times\vec{B}=\mu_0\vec{J}}$ \quad 2. Maxwell: $\boxed{\nabla\cdot\vec{B}=0}$
...
$\boxed{d\vec{B}=\dfrac{\mu_0 \icc{I}}{4\pi r^2}(d\vec{l}\times\hat{r})=\dfrac{\mu_0 \icc{I}}{4\pi r^3}|d\vec{l}\times\vec{r}|}$

für Punktladung $q$: $\boxed{\vec{B}=\dfrac{\mu_0 q}{4\pi r^2}(\vec{v}\times\hat{r})}$

Magnetfeld unendlicher Spule: $\boxed{B_z=\mu_0 nI}$

Kreisförmiger Leiter auf $z$-Achse:
$B_z(0,0,z)=\dfrac{\mu_0 R^2 I}{2(R^2+z^2)^{3/2}}$ \quad insbes.: $B_z(0,0,0)=\dfrac{\mu_0 \icc{I}}{2R}$

Unendlich langer dünner Leiter: $B=\mu_0\dfrac{\icc{I}}{2\pi R}$
...
$\boxed{E'_\parallel=E_\parallel}$ \quad $\boxed{E'_\perp=\gamma(E_\perp+c\vec{\beta}\times\vec{B}_\perp)}$

$\boxed{B'_\parallel=B_\parallel}$ \quad $\boxed{B'_\perp=\gamma\!\left(B_\perp-\tfrac{1}{c}\vec{\beta}\times\vec{E}_\perp\right)}$
...
Isolierter Leiter: $\boxed{\vec{E}_{\text{int}}=-\vec{v}\times\vec{B}}$

Magnetischer Fluss: $\boxed{\Phi(t)=\int_A\vec{B}\cdot d\vec{a}}$

Induzierte Spannung: $\boxed{\varepsilon=-\frac{d\Phi}{dt}=\oint_C\vec{E}\cdot d\vec{L}=-\frac{d}{dt}\int_A\vec{B}\cdot d\vec{a}}$
...
fallende Leiterschleife: $\boxed{F=\icc{I_{\text{ind}}}aB}$ \quad $a$: Seitenlänge
...
\hline
$\nabla\cdot\vec{E}=\frac{\rho}{\varepsilon_0}$ & $\int_{\partial V}\vec{E}\cdot d\vec{a}=\frac{Q_{\text{in}}}{\varepsilon_0}$ \\
$\nabla\cdot\vec{B}=0$ & $\int_{\partial V}\vec{B}\cdot d\vec{a}=0$ \\
$\nabla\times\vec{E}=-\frac{\partial\vec{B}}{\partial t}$ & $\oint\vec{E}\cdot d\vec{s}=-\frac{\partial}{\partial t}\int_V\vec{B}\cdot d\vec{a}$ \\
$\nabla\times\vec{B}=\mu_0\vec{J}+\mu_0\varepsilon_0\frac{\partial\vec{E}}{\partial t}$ & $\oint\vec{B}\cdot d\vec{s}=\mu_0 \icc{I_{\text{eing}}}+\mu_0\varepsilon_0\frac{\partial}{\partial t}\int_V\vec{E}\cdot d\vec{a}$ \\
...
Verschiebungsstrom: $\boxed{\icc{I_V}=\int\varepsilon_0\dfrac{\partial\vec{E}}{\partial t}\,d\vec{a}}$

\subsection{Homogene Wellengleichung}

$\boxed{\Delta\vec{B}-\varepsilon_0\mu_0\dfrac{\partial^2\vec{B}}{\partial t^2}=0}$ \quad $\boxed{\Delta\vec{E}-\varepsilon_0\mu_0\dfrac{\partial^2\vec{E}}{\partial t^2}=0}$

Ausbreitungsgeschwindigkeit: $\boxed{c:=v=\dfrac{1}{\sqrt{\varepsilon_0\mu_0}}=\dfrac{E_0}{B_0}}$

\subsection{Energietransport}

Poynting-Vektor: $\boxed{\vec{S}=\dfrac{1}{\mu_0}\vec{E}\times\vec{B}}$ \quad $|\vec{S}|=$ Intensität

Momentaner Transport: $P=\int_A\dfrac{1}{\mu_0}(\vec{E}\times\vec{B})\,d\vec{a}$
...
$\boxed{\vec{P}=N\vec{p}}$ \quad $\boxed{\vec{D}=\varepsilon_0\vec{E}+\vec{P}}$ \quad $\vec{P}=\varepsilon_0(\varepsilon-1)\vec{E}$
...
$\boxed{\vec{M}=\vec{\mu}\times\vec{B}}$ \quad $|\vec{M}|=\mu B\sin\theta$ \quad $F_z=\mu\nabla_z B$

\textbf{3. Potentielle Energie:}
$\boxed{\ec{U}=-\vec{\mu}\cdot\vec{B}=-\mu B\cos\theta}$
