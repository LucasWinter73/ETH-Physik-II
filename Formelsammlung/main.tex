...
Feld $xy$-Ebene: $\boxed{\efc{E_z}=\dfrac{-qh}{2\pi\varepsilon_0(r^2+h^2)^{3/2}}}$ \quad $Q=\varphi\cdot V$

Ladungsdichte: $\boxed{\sigma=\varepsilon_0 \efc{E_z}=\dfrac{-qh}{2\pi(r^2+h^2)^{3/2}}}$ \quad $\icc{I}=\tfrac{dQ}{dt}=\tfrac{d}{dt}(\varphi\cdot V)$
...
Kapazität: $\boxed{Q=C\varphi=CV}$ \quad Zylinderspule: $\boxed{C=\tfrac{2\pi\varepsilon_0 L}{\ln(R_A/R_I)}}$ \quad $\boxed{\ec{E}=\tfrac{1}{2}CV^2}$
...
Strom durch Fläche: $\boxed{\icc{I_A}=\int_{\partial V}\vec{J}\,d\vec{a}=\oint_A\vec{J}\,d\vec{a}}=JA$ \quad $[J]=\text{A/m}^2$
...
Widerstand: $\boxed{R=\dfrac{V}{\icc{I}}=\int_{r_1}^{r_2}\dfrac{dr}{\sigma A(r)}}$ \quad $\boxed{R=\dfrac{\rho L}{A}}$ \; $\rho=1/\sigma$: spez. Widerstand
...
El. Hall-Feld: $\boxed{\efc{E_H}=\dfrac{U_H}{d}}$ \quad Hall Spannung: $\boxed{U_H=\efc{E_H} d=\bar{v}\bfc{B}d}$ $=\int\efc{\vec{E}}\,ds$
...
Gegeninduktivität: $\boxed{M_{21}=\dfrac{\Phi_{21}}{\icc{I_1}}}$ \quad $[M]=H=\Omega s=\text{Vs}/\text{A}$
...
Induzierte Spannung: $\boxed{\varepsilon_{\text{ind}}=-L\dfrac{\icc{dI}}{dt}}$ \quad $[L]=1H=\Omega s=\text{Vs}/\text{A}$
