...
\fl{\textbf{Gedämpfter Oszillator:}}{\ec{E}(t)=E_0\,e^{-\gamma t},\quad \gamma=\dfrac{R}{m}}
...
Stromdichte: $\boxed{\vec{J}=nq\bar{v}=\rho v=\dfrac{I}{A}}$ \quad $\bar{v}$: mittlere Driftgeschwindigkeit, $\vec{J}\parallel d\vec{l}$

Strom durch Fläche: $\boxed{I_A=\int_{\partial V}\vec{J}\,d\vec{a}}=JA$ \quad $[J]=\text{A/m}^2$
...
Stromdurchflossener Leiter: $\boxed{\vec{F}_L=I(\vec{\ell}\times\vec{B})}$

Ampersches Gesetz: $\boxed{\mu_0 I=\oint_{\partial A}\vec{B}\,ds}$
...
Magn. Feld unendl. langer Draht: $\boxed{B=\mu_0\dfrac{I}{2\pi r}}$ \quad $\boxed{\vec{B}=\dfrac{\vec{k}}{\omega}\times\vec{E}}$

Magnetfeld Zylinderspule: $\boxed{B=\mu_0\dfrac{N}{L}I}$ \quad $N$: Gesamtwindungen, $L$: Länge

\subsection{Ampere'sches Gesetz}

$\boxed{\oint_{\partial A}\vec{B}\,ds=\mu_0 I_{\text{eing}}=\mu_0\int_A\vec{J}\,d\vec{a}}$ \quad wähle Weg parallel zu $\vec{B}$
...
$\boxed{d\vec{B}=\dfrac{\mu_0 I}{4\pi r^2}(d\vec{l}\times\hat{r})=\dfrac{\mu_0 I}{4\pi r^3}|d\vec{l}\times\vec{r}|}$
...
Induzierter Strom: $\boxed{I_{\text{ind}}=\dfrac{U_{\text{ind}}}{R}=\dfrac{\varepsilon}{R}=-\dfrac{1}{R}\dfrac{d\Phi}{dt}}$
...
$\boxed{\dfrac{\Phi_{12}}{I_2}=\dfrac{\Phi_{21}}{I_1}}$
...
Selbstinduktivität Spule: $\boxed{L=\dfrac{\Phi}{I}=\mu_0\dfrac{AN^2}{l}}$ \quad $A$: Querschnittfläche, $N$: Windungen
...
$\nabla\times\vec{B}=\mu_0\vec{J}+\mu_0\varepsilon_0\frac{\partial\vec{E}}{\partial t}$ & $\oint\vec{B}\cdot d\vec{s}=\mu_0 I_{\text{eing}}+\mu_0\varepsilon_0\frac{\partial}{\partial t}\int_V\vec{E}\cdot d\vec{a}$ \\
...
Verschiebungsstrom: $\boxed{I_V=\int\varepsilon_0\dfrac{\partial\vec{E}}{\partial t}\,d\vec{a}}$
...
$\boxed{\vec{\mu}=I\cdot\vec{A}}$ \quad $|\vec{\mu}|=I\cdot A$
